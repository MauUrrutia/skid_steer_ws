...
class pd_motion_planner(Node):
    ...
    def control_loop(self):
        ...
        dz = next_pose.pose.position.z - robot_pose.pose.position.z
        ...
        self.next_pose_publisher.publish(next_pose)
        ...
        next_pose_tf[2][3] = next_pose.pose.position.z
        ...
        dt = (self.get_clock().now() - self.last_cycle_time).nanoseconds * 1-9
