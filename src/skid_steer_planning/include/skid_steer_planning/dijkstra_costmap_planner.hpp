#ifndef _DIJKSTRA_COSTMAP_PLANNER_HPP_
#define _DIJKSTRA_COSTMAP_PLANNER_HPP_
...
class DijkstraCostmapPlanner: public rclcpp::Node
{
private:
...
public:
    DijkstraCostmapPlanner(const std::string &name);
    ~DijkstraCostmapPlanner();
